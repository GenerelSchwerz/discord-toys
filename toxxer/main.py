...
async def get_report_info(
    token: str, type: Union[Literal["user"], Literal["guild"], Literal["message"]]
):
...
async def send_report(
    token: str,
    type: Union[Literal["user"], Literal["guild"], Literal["message"]],
    payload: dict,
):
...
async def main():
    ...
    wanted_reason = search_breadcrumb(
        report_data, "photos or videos depicting real world child"
    )
